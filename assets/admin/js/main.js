...
// Account Menu
const showAccountOptions = document.querySelector('.show-options');
const accountOptions = document.querySelector('.account-menu');

showAccountOptions.addEventListener('click', () => {
    accountOptions.classList.toggle('opacity-account-menu');
});